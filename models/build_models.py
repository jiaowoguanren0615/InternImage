...
class InternViT6B(nn.Module):
    ...
    def __init__(self, in_chans=3, patch_size=14, img_size=224, pretrain_size=224, qkv_bias=False, drop_path_rate=0.0,
                 ...
                 head_norm_type='bn', pretrained=None, **kwargs):
        super().__init__()
...
@register_model
def Build_InternViT_6B(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    model_kwargs = dict(drop_path_rate=0.1, **kwargs)
    return InternViT6B(**model_kwargs)